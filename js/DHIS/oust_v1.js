...
function SelectionTree()
{
	...
	this.setSelectedOrganisationUnits = function( _selectedOrganisationUnit )
	{
		selectedOrganisationUnit = _selectedOrganisationUnit;
	}
    ...
    {
		var parentId = $( parentElement ).attr("parentId");
        ...
        for ( var i = 0, child; ( child = children[i] ); ++i )
        {
        	...
        	{
        		var childTag = createTreeElementTag( child, parentId );
    ...
    function createTreeElementTag( child, parentId )
    {
		...
		childTag.setAttribute( "parentId", parentId );
